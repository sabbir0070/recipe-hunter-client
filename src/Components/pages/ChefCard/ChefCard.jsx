    ...
    <div className="card  rounded-lg p-3  bg-base-100 mt-8 shadow-xl">
      ...
      <div className="card-body hover:bg-base-200 ">
        ...
        <div className="  flex gap-x-16 justify-between ">
          <Link to={`/chefrecipes/${id}`}><button className="px-6 py-2 font-semibold rounded bg-indigo-500 text-white hover:bg-indigo-700 "> View Recipes </button> </Link>
          <p className='text-gray-800 flex items-center text-lg font-semibold'>
<HandThumbUpIcon className='w-10 h-10  mr-2 text-indigo-700'></HandThumbUpIcon> <span className='text-3xl text-red-700'>{likes}</span>
</p>
        </div>
      </div>
    </div>
