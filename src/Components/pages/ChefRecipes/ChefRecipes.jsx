...
const {id, chef_name,specialty, chef_picture, experience, likes, number_of_recipes,description,recipes} =data;
...
{/* <p className="text-gray-600 text-lg font-semibold "> <span className='font-semibold text-lg text-blue-600'> Speacialty:</span> {speacialty} </p> */}
