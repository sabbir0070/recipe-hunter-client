...
const Banner = () => {
  return (
    <div className='w-100 h-100'>
      <img className='bg-cover opacity-90 index-0 w-full h-full relative' src={banner} alt="" />
      <div className='absolute top-0 w-full lg:mt-96 mt-40  sm:mt-72 px-1  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl '>
        <div className='text-center'>
          ...
          <p className='text-gray-200 text-3xl font-bold hover:text-red-200 mt-3'> Get pre-portioned ingredients <br /> for Gusto Meal Kits  <br /> best recipes direct to your door </p>
        </div>
      </div>
    </div>
  );
