    ...
    <div className='w-100 h-90'>
      ...
      <div className='absolute top-0 w-full lg:mt-96 mt-40  sm:mt-72 px-1  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl '>
        <div className='text-center bg-base-600 opacity-110 rounded-full'>
          <p className='text-5xl  hover:text-blue-600 font-bold index-1 text-green-600 leading-tight '>CLEAN EATING CHALLENGE<br />   <span className='text-fuchsia-700 hover:text-red-600'>For Weight Loss.</span> </p>
